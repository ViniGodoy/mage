...
public class Mesh {
    ...
    private Mesh putUniform(String name, Object value) {
        if (value == null)
    ...
    public Mesh draw(Material material) {
        ...
        for (Map.Entry<String, Object> entry : uniforms.entrySet()) {
            shader.setUniformObj(entry.getKey(), entry.getValue());
        }
